...
console.log(Logic3.evaluate(null).toString())         // null, undefined and NaN is converted to Nil
console.log(Logic3.evaluate(undefined).toString())    //
console.log(Logic3.evaluate(Math.sqrt(-1)).toString())//
